...
class ScrollTrigger extends Component {
  ...
  componentDidMount() {
    ...
    let scrollingElement = typeof containerRef === 'string'
      ? document.querySelector(containerRef)
      : containerRef;

    scrollingElement.addEventListener('resize', this.onResizeThrottled);
    scrollingElement.addEventListener('scroll', this.onScrollThrottled);
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (prevProps.throttleScroll !== this.props.throttleScroll) {
      scrollingElement.removeEventListener('scroll', this.onScrollThrottled);
    ...
    if (prevProps.throttleResize !== this.props.throttleResize) {
      scrollingElement.removeEventListener('resize', this.onResizeThrottled);
